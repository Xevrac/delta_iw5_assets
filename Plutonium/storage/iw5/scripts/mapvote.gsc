...
init() {
    ...
    level.mapvotetype = strtok("DELTA_TDM#DELTA_INFECTED#DELTA_HCTDM#DELTA_FFA#DELTA_DOM#DELTA_HCFFA#DELTA_SND", "#");
...
maptostring(map,type) {    
    ...
    break;
	case "DELTA_TDM":map = map + " (^9TEAM DEATHMATCH^7)" + ":0";
	break;
	case "DELTA_INFECTED":map = map + " (^9INFECTED^7)" + ":0";
	break;
	case "DELTA_HCTDM":map = map + " (^1HARDCORE ^9TEAM DEATHMATCH^7)" + ":0";
	break;
	case "DELTA_FFA":map = map + " (^9FREE FOR ALL^7)" + ":0";
	break;
	case "DELTA_DOM":map = map + " (^9DOMINATION^7)" + ":0";
	break;
	case "DELTA_HCFFA":map = map + " (^1HARDCORE ^9FREE FOR ALL^7)" + ":0";
	break;
	case "DELTA_SND":map = map + " (^9SEARCH & DESTORY^7)" + ":0";
	break;
    default:
    break;
    }    
